...
public class JavaMelodyConfiguration {
	...
	public MonitoringSpringAdvisor springServiceMonitoringAdvisor() {
		...
		interceptor
				.setPointcut(createAnnotationMatchingPointcut(Service.class));
		return interceptor;
	}
	...
	public MonitoringSpringAdvisor springControllerMonitoringAdvisor() {
		final MonitoringSpringAdvisor interceptor = new MonitoringSpringAdvisor();
		interceptor
				.setPointcut(createAnnotationMatchingPointcut(Controller.class));
		return interceptor;
	}
	...
	public MonitoringSpringAdvisor springRestControllerMonitoringAdvisor() {
		final MonitoringSpringAdvisor interceptor = new MonitoringSpringAdvisor();
		interceptor
				.setPointcut(createAnnotationMatchingPointcut(RestController.class));
		return interceptor;
	}

	private AnnotationMatchingPointcut createAnnotationMatchingPointcut(
			Class annotation) {
		return new AnnotationMatchingPointcut(annotation) {
			@Override
			public ClassFilter getClassFilter() {
				AnnotationClassFilter annotationClassFilter = new AnnotationClassFilter(
						annotation) {
					@Override
